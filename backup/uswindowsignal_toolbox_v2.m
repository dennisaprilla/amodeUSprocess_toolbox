function varargout = uswindowsignal_toolbox_v2(varargin)
% USWINDOWSIGNAL_TOOLBOX_V2 MATLAB code for uswindowsignal_toolbox_v2.fig
%      USWINDOWSIGNAL_TOOLBOX_V2, by itself, creates a new USWINDOWSIGNAL_TOOLBOX_V2 or raises the existing
%      singleton*.
%
%      H = USWINDOWSIGNAL_TOOLBOX_V2 returns the handle to a new USWINDOWSIGNAL_TOOLBOX_V2 or the handle to
%      the existing singleton*.
%
%      USWINDOWSIGNAL_TOOLBOX_V2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in USWINDOWSIGNAL_TOOLBOX_V2.M with the given input arguments.
%
%      USWINDOWSIGNAL_TOOLBOX_V2('Property','Value',...) creates a new USWINDOWSIGNAL_TOOLBOX_V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before uswindowsignal_toolbox_v2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to uswindowsignal_toolbox_v2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help uswindowsignal_toolbox_v2

% Last Modified by GUIDE v2.5 30-Aug-2022 13:29:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @uswindowsignal_toolbox_v2_OpeningFcn, ...
                   'gui_OutputFcn',  @uswindowsignal_toolbox_v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before uswindowsignal_toolbox_v2 is made visible.
function uswindowsignal_toolbox_v2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to uswindowsignal_toolbox_v2 (see VARARGIN)
...
% Choose default command line output for uswindowsignal_toolbox_v2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes uswindowsignal_toolbox_v2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = uswindowsignal_toolbox_v2_OutputFcn(hObject, eventdata, handles) 
...
default_lowerbound = str2num(get(handles.edit_windowlowerbound, 'String'));
default_upperbound = str2num(get(handles.edit_windowupperbound, 'String'));
...
for i=1:data_spec.n_ust
    ...
    probeProperties.WindowLowerBound(i) = default_lowerbound;
    probeProperties.WindowUpperBound(i) = default_upperbound;
end
...
struct2ini( strcat(path, fname), probeProperties );
