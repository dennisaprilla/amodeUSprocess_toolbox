...
% signal processing
[envelope_data, correlated_data] = process_USsignal(data, data_spec, us_spec);
...
handles.data                = data;
handles.correlated_data     = correlated_data;
...
data             = handles.data;
correlated_data  = handles.correlated_data;
